...
\begin{frame}{Module Customization}
  ...
  \begin{block}{Using Modules with Libraries}
   ...
   \end{itemize}
  \end{block}
  \note{FFTW Docs: \\ \url{http://cac.engin.umich.edu/resources/software/fftw3.html} \\  There is an example fftw3.c located on that page that will work with the example on the slide.  Note that fftw-2.x is not compatible with fftw-3.x use 3 when available as it is much faster. }
\end{frame}
