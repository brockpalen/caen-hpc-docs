...
\begin{frame}{Module Fun}
  ...
  \end{itemize}
  \note[item]{example suing fftw follows}
  \end{block}
\end{frame}
...
\begin{frame}{Interactive Jobs}
 \begin{block}{Interactive Jobs}
  \uncover<2-> {The CAC has CPU's for jobs 15 minutes or less \\}
  \uncover<2-> {These CPU's can be used for testing PBS scripts and debugging code \\}
