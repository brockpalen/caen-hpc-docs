...
%table of contents
  ...
  \begin{frame}{Hardware}
   \begin{block}{Compute Hardware}
    ...
    \item 639 Opteron nodes, over 2060 cores
...
/home provides read-only snapshots. These allow users to recover deleted/modified files from the past.  Snapshops are located at /home/.snapshot
} %end note
\end{frame}
...
\uncover{mpirun -np 16 mcnp5.mpi i=input2 o=output2 r=restart2}
 ...
 \note[item]{-l sets the resources, walltime=HH:MM:SS or walltime=SSSSS Total number of cpus is nodes*ppn which must email -np.}
...
\begin{frame}{Interactive Jobs}
 ...
 \begin{block}{Example}
  ...
  \note[item]{\texttt{qsub -I -X nodes=2:ppn=2,walltime=15:00 -q route}}
...
this is read by six people.  The odds of a quick reply are best this way.
 ...
 \end{block}
 \begin{block}{Survey}
    \url{https://www.engin.umich.edu/form/exit08\_01}
 \end{block}
\end{frame}
\end{document}
