...
\begin{itemize}
 ...
 \item Ranks work on a subset of the intervals. Ranks step by n+nproc intervals each itteration
...
\begin{frame}{Warnings with Collectives}
 \begin{block}{Warnings}
  \begin{itemize}
   \item Avoid \texttt{MPI\_Barrior()}
   \item \texttt{MPI\_Alltoall()} requires n*(n-1) sends
   \item \texttt{}
  \end{itemize}
 \end{block}
\end{frame}
