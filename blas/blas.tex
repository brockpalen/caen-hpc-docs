...
\begin{frame}{Free Performance}
 ...
 \end{block}
 \note{
  Most major perfromance gains come from major changes in structer. To take advantage of these changes users would need to recompile their code. A way a user can avoid this is by using a BLAS that was already built to take advantage of the new hardware. \\

Major Changes:\\
\begin{itemize}
 \item Barcelong 128bit SIMD double peak spead/hz
